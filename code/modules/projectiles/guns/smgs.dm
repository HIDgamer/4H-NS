...
/obj/item/weapon/gun/smg/p90
	...
	desc = "The FN P90 submachine gun. An archaic design, but still widely used by corporate and mercenary groups, sometimes seen in the hands of civilian populations. This weapon only accepts 5.7Ã—28mm rounds."
	icon = 'icons/obj/items/weapons/guns/guns_by_faction/colony/smgs.dmi'
	icon_state = "p90"
	item_state = "p90"
...
/obj/item/weapon/gun/smg/p90/twe
	...
	desc = "The FN Herstal FN-P90 submachinegun. Occasionally carried by light-infantry, scouts, engineers and medics. A lightweight, lower caliber alternative to the various Pulse weapons used the RMC. Fires 10x20mm rounds out of 50 round magazines. This weapon only accepts the 5.7Ã—28mm round."
